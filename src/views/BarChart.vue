...
export default {
  name: 'BarChart',
  extends: Bar,
  props: ['dataChart_Reve', 'dataChart_Income'],
  mounted () {
  ...
  computed: {
    chartData1 () {
      return this.dataChart_Reve
    },
    chartData2 () {
      return this.dataChart_Income
    }
  },
  watch: {
    dataChart_Reve: function () {
      this.$data._chart.data.datasets[0].data = this.dataChart_Reve // inicializa
      this.$data._chart.data.datasets[1].data = this.dataChart_Income // inicializa
